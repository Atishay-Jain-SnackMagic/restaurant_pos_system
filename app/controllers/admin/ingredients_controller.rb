class Admin::IngredientsController < Admin::ApplicationController
  ...
  def destroy
    if @ingredient.destroy
      redirect_to admin_ingredients_path, notice: t('controllers.admin.ingredients.destroy.success')
    else
      redirect_to admin_ingredients_path, notice: t('controllers.admin.ingredients.destroy.failure')
    end
  end
